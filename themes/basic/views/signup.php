        ...
        <div class="oauth-form">
            ...
            <div class="tab-content pb15">
                ...
                <div class="tab-pane fade in active">
                    ...
                    <?php if(get_option('google_captcha_enable', 0) == 1 && get_option('google_captcha_client_id', '') != "" && get_option('google_captcha_client_secret', '') != ""){?>
                    <div class="form-group">
                        <div class="g-recaptcha" data-sitekey="<?=get_option('google_captcha_client_id', '')?>"></div>
                    </div>
                    <?php }?>
                    <div class="checkbox">
                        <div class="pure-checkbox grey mr15 mb15">
                            <input type="checkbox" id="md_checkbox_schedule" name="terms" class="filled-in chk-col-red enable_instagram_schedule" value="on">
