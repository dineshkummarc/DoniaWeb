                ...
                <div class="tab-pane fade show active" id="pills-month" role="tabpanel" aria-labelledby="pills-month-tab">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="pricing-box text-center" data-av-animation="bounceInUp">
                                <div class="price-header">
                                    <div class="pricing-box-text">
                                    <h4><?=$row->name?></h4>
                                    <p><?=$row->description?></p>
                                    <div class="price-price">
                                        <div class="price-box-count text-center md-30">
                                            <h1><span class="usd">$</span><?=$pricing_monthly_explode[0]?>.<?=$pricing_monthly_explode[1]?></h1> <sup><?=get_option('payment_symbol')?></i></sup>
                                        </div>
                                ...
                                <div class="price-body">
                                    <div class="price-info" style="font-size: 15px;">
                                ...
                                <div class="price-footer">
                                    <a href="<?=(session("uid"))?cn('payment/'.$row->ids.'?type=1'):cn("auth/login?redirect=payment/".$row->ids.'?type=1')?>" class="btn"><?=lang('upgrade_now')?><i class="dripicons-arrow-thin-right"></i></a>
                                </div>
                            </div>
                        </div>  
                        <?php }}?>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="pricing-box text-center" data-av-animation="bounceInUp">
                                <div class="price-header">
                                    ...
                                    <p><?=$row->description?></p>
                                    <div class="price-price">
                                        <div class="price-box-count text-center">
                                            <h1><span class="usd">$</span><?=$pricing_anually?></h1> <sup><?=get_option('payment_symbol')?></i></sup>
                                        </div>
                                        <small><?=lang("per_active_user_monthly")?></small>
                                        <br/>
                                        <small class="text-warning"><?=sprintf(lang("save_x_on_annually"), $pricing_discount." ".get_option('payment_currency'));?></small>
                                ...
                                <div class="price-body">
                                    ...
                                    <ul style="font-size: 17px;">
                                        ...
                                        if(!empty($social_list)){
                                            foreach ($social_list as $key => $name) {
                                        ?>
                                        <li class="<?=in_array($name, $social_list_permission)?"":"no"?>"style="font-size: 17px;"><b><?=lang(strtolower($name))?></b> <?=lang('scheduling_automation')?></li>
                                        <?php }}?>
                                        <li> <?=lang('premium_support')?></li>
                                        <li> <?=lang('spintax_support')?></li>
                                        <li class="<?=in_array("watermark", $permission)?"":"no"?>"> <?=lang('watermark_support')?></li>
                                  ...
                                  <br/>
                                <div class="price-footer">
                                    <a href="<?=(session("uid"))?cn('payment/'.$row->ids.'?type=2'):cn("auth/login?redirect=payment/".$row->ids.'?type=2')?>" class="btn"><?=lang('upgrade_now')?><i class="dripicons-arrow-thin-right"></i></a>
                                </div>
                            </div>
                        </div>  
                        <?php }}?>
        ...
        <div class="pricing-tab-menu text-center mt-50">
            <ul class="nav pricing-tab justify-content-center" id="pills-tab" role="tablist">
                <li class="nav-item">
