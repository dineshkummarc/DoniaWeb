		                    ...
		                    <tr>
		                    	...
		                    	<td>
		                        	...
		                        	<div class="btn-group btn-group-option <?=($key + 1 == count($result)?"dropup":"")?>">
									  	...
									  	<a class="btn btn-default actionItem" href="<?=cn($module."/ajax_delete_item")?>" data-id="<?=$row->ids?>" data-redirect="<?=cn($module)?>" data-confirm="<?=lang("are_you_sure_want_delete_it")?>" class="actionItem"><i class="fas fa-trash-alt"></i></a>
