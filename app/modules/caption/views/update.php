			  	...
			  	<div class="card">
			  		...
			  		<div class="card-body pl15 pr15">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control post-message" name="caption" rows="3" placeholder="<?=lang('add_a_caption')?>" style="height: 214px;"><?=(!empty($result))?specialchar_decode($result->content):"";?></textarea>
