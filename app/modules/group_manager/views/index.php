...
<div class="row pn-mode pn-mode-settings m-t--30">
    ...
    <div class="pn-sidebar pn-scroll card">
        ...
        <div class="pn-box-sidebar">
            ...
            <h3 class="head-title"><?=lang("Group manager")?> <a href="<?=cn("group_manager/index/add")?>" class="pull-right text-primary" title="<?=lang("add_new")?>"><i class="fas fa-plus-circle"></i></a></h3>
