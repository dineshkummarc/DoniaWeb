<div class="head-title"><i class="ft-user"></i> <?=lang("List users")?></div>
		  				...
		  				<div class="row">
		  					...
		  					<div class="col-md-9 col-sm-6 mb-mobile-15">
		  						...
		  						<div class="btn-group" role="group" aria-label="export">
								    ...
								    <a href="<?=cn($module."/ajax_delete_item")?>" class="btn btn-default actionMultiItem" data-redirect="<?=cn($module)?>" data-confirm="<?=lang("are_you_sure_want_delete_it")?>"><i class="fas fa-trash-alt"></i> <?=lang("delete")?></a>
		                    ...
		                    <tr>
		                    	...
		                    	<td>
		                        	...
		                        	<div class="btn-group btn-group-option <?=($key + 1 == count($result)?"dropup":"")?>">
									  	...
									  	<a href="<?=cn($module."/update/".$row->ids)?>" class="btn btn-default"><i class=" far fa-edit"></i></a>
									  	...
									  	<div class="btn-group">
									    	...
									    	<ul class="dropdown-menu dropdown-menu-left" role="menu">
									      		...
									      		<li><a href="<?=cn($module."/view_user/".$row->ids)?>" data-id="<?=$row->ids?>" data-redirect="<?=cn("dashboard")?>" class="actionItem"><?=lang("View user")?></a></li>
