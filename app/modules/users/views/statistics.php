		...
		<div class="col-md-4">
			...
			<div class="widget">
				...
				<div class="media">
	                ...
	                <div class="media-right media-middle" style="margin: auto;">

	                    <i class="fas fa-users primary font-large-2 float-right"></i>
			...
			<div class="widget">
				...
				<div class="media">
	                ...
	                <div class="media-right media-middle" style="margin: auto;">
	                    ...
	                    <i class="fas fa-user-check success font-large-2 float-right"></i>
			...
			<div class="widget">
				...
				<div class="media">
	                ...
	                <div class="media-right media-middle" style="margin: auto;">
	                    ...
	                    <i class="fas fa-user-times danger font-large-2 float-right"></i>
