				...
				<ul>
					...
					<li>
						<div class="pure-checkbox grey">
							<input type="checkbox" data-plugin="switchery" data-color="#64b0f2"
								name="social_filter[]" id="md_checkbox_<?=$row->title?>" class="filled-in chk-col-red sc-action"
								checked="" value="<?=str_replace(" ", "_", $row->title)?>">
