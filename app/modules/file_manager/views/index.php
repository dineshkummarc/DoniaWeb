    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title float-left"><?=lang('file_manager')?></h4>
                <ol class="breadcrumb float-right">
                    <li class="breadcrumb-item"><a href="#"><?=lang('file_manager')?></a></li>
                </ol>
            ...
            <div class="card mb0 bra0">
                ...
                <div class="card-header file-manager-header">
                    ...
                    <div class="card-title">
                        ...
                        <i class="far fa-folder" aria-hidden="true"></i> <?=lang('file_manager')?> 
                    ...
                    <div class="pull-right">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="btn btn-default fileinput-button" >
                                ...
                                <i class="fas fa-upload"></i> <span> <?=lang('upload')?></span>
                            ...
                            <button type="button" class="btn btn-default delete_multi_files">
                                ...
                                <i class="far fa-trash-alt"></i> <span> <?=lang('delete')?></span>
