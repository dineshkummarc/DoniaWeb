<div class="row pn-mode pn-mode-users">
    ...
    <div class="pn-sidebar pn-scroll">
        ...
        <div class="pn-box-sidebar">
            ...
            <h3 class="head-title"><?=lang("Package manager")?> <a href="<?=cn("packages/index/add")?>" class="pull-right text-primary" title="<?=lang("add_new")?>"><i class="fas fa-plus-circle"></i></a></h3>
