        ...
        <div class="card-header">
            <div class="card-title">
                ...
                <div class="pull-right card-option">
                    <a href="<?=cn($module."/popup_add_account")?>" class="ajaxModal" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?=lang("add_board")?>"><i class="ft-plus"></i></a>
                </div>
            </div>
        </div>
