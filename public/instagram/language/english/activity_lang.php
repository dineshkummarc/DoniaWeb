...
$lang['Unfollowed_user']    = 'Unfollowed user';
...
$lang['Repost_medias_per_day']    = 'Repost medias per day';
...
$lang["you_can_use_following_variables_in_the_messages_desc_note"] = "You can use following variables in the messages:<br/><strong>{{username}}</strong> Media owner's username<br/><strong>{{full_name}}</strong> Media owner's full name. If user's full name is not set, username will be used.<br/><strong>{{break}}</strong> Insert a line break to start a new line of text.";
$lang['new_followers'] = 'New followers';
$lang['repost_media_by'] = 'Repost media by';
$lang['repost_media_by_desc'] = '<b>Tags</b> — select this option if you want to repost media on list hashtags<br/><br/>
							<b>Usernames</b> — select this option if you want to repost media on list usernames<br/><br/>
							<b>Locations</b> — select this option if you want to repost media on list locations<br/><br/>';
$lang['Never'] = 'Never';
$lang['Odd'] = 'Odd';
$lang['Even'] = 'Even';
