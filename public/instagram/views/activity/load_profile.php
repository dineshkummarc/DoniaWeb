...
<div class="col-md-3 mb15" id="id<?=$row->id?>">
	...
	<div class="item">
		...
		<div class="item-info">
			...
			<a href="<?=cn("instagram/activity/delete_media/".segment(4)."/".$row->id)?>" class="type pull-right p0 actionItem" data-toggle="tooltip" data-placement="left" title="" data-original-title="Delete"><i class="far fa-trash-alt"></i></a>
