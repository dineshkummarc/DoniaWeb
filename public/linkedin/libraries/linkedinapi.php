...
if(!class_exists("linkedinapi")){
    class linkedinapi{
        ...
        function login_url($full_permissions = true){
            if($full_permissions){
                $scopes = "r_emailaddress r_liteprofile w_member_social w_organization_social r_organization_social rw_organization_admin";
            }else{
                $scopes = "r_emailaddress r_liteprofile w_member_social";
            }

            $login_url = $this->client->getPermissionUrl( $scopes );
        ...
        function get_access_token(){
            try {
                if(get("code")){
                    ...
                    if(stripos($error, 'w_organization_social') !== false){
                        redirect( $this->login_url(false) );
                    }
        ...
        function post($data, $account = array()){
            if($account->type == "page"){
                $author = "urn:li:organization:".$account->pid;
            }else{
                $author = "urn:li:person:".$account->pid;
            }
            ...
            try {
                ...
                switch ($data->type) {
                    ...
                    case 'media':
                        ...
                        $media = $this->client->upload($media, $author);
                ...
                $response = (object)$this->client->share($content, $author);
