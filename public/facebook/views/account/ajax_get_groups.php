    ...
    <table class="table table-bordered table-datatable mb0" width="100%">
        <thead>
            <tr>
                ...
                <th>
                    <span class="text"> <?=lang('type')?></span>
                </th>
                <th>
        ...
        <tbody>
            ...
            <tr>
            	<td>
            		<div class="pure-checkbox grey mr15">
                    	<input type="checkbox" name="id[]" id="check_<?=row($row, "ids")?>" class="filled-in chk-col-red checkItem" value="<?=row($row, "ids")?>">
						<label class="p0 m0" for="check_<?=row($row, "ids")?>">&nbsp;</label>
					</div>
            	</td>
                <td><a target="_blank" href="https://fb.com/<?=row($row, "pid")?>"><?=row($row, "pid")?></a></td>
                <td><a target="_blank" href="https://fb.com/<?=row($row, "pid")?>"><?=row($row, "name")?></a></td>
