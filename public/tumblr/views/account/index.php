    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <div class="card-title">
                ...
                <i class="<?=$module_icon?>" aria-hidden="true"></i> <?=lang("tumblr_accounts")?>

                <div class="pull-right card-option">

                    <a href="<?=cn($module."/oauth")?>" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?=lang("add_account")?>"><i class="fas fa-plus"></i></a>
        ...
        <div class="card-block p0">
            ...
            <div class="account-manager-list scrollbar scrollbar-dynamic">
                ...
                <div class="item">
                    ...
                    <a class="am-info" href="https://www.tumblr.com/blog/<?=$row->username?>" target="_blank">
