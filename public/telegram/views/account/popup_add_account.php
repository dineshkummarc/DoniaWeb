    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-title"><i class="<?=$module_icon?>"></i> <?=$module_name?></div>
            </div>
            <div class="modal-body p15">
                <div class="col-sm-12">
                    <div class="row form-notify"></div>
                    <div class="form-group">
                        <label class="control-label" for="username"><?=lang("Enter Telegram Api Key")?></label>
                        <input type="text" name="code" class="form-control">
                    </div>
                </div>
                <a href="https://web.telegram.org" target="_blank" class="openOauthVK hide"></a>
