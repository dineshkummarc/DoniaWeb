            ...
            <div class="account-manager-list scrollbar scrollbar-dynamic">
                    ...
                    <div class="am-option">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="<?=cn($module."/popup_add_account")?>" class="ajaxModal" data-id="<?=$row->ids?>"><?=lang("edit")?></a></li>
                ...
                <?php }}else{?>
                    <div class="empty">
                        ...
                        <a href="<?=cn($module."/popup_add_account")?>" class="ajaxModal btn btn-primary"><?=lang("add_account")?></a>
                    </div>
                <?php }?>
            </div>
        </div>
