...
<div class="wrap-content telegram-app row app-mod">
        ...
        <div class="am-content col-md-6 am-scroll pl15 pr15">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="tab-type schedule-telegram-type file-manager-change-type">


                        <a href="#media" class="col-xs-4 col-sm-4 col-md-4 item active" data-toggle="tab" data-type="media" data-type-image="single">
                ...
                <div class="tab-content b0 mt15">
                    ...
                    <div id="link" class="tab-pane fade in">
                        ...
                        <div class="form-group form-help">
                            ...
                            <input type="text" class="form-control" name="link" placeholder="<?=lang("Enter your link")?>" value="<?=$link?>">
